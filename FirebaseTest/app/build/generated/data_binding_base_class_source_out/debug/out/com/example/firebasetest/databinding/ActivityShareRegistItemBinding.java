...
public final class ActivityShareRegistItemBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityShareRegistItemBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityShareRegistItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityShareRegistItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_share_regist_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityShareRegistItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityShareRegistItemBinding((ConstraintLayout) rootView, btnBack, btnCancel,
          btnHome, btnItemRegist, inputItemCategory, inputItemExplain, inputItemImg1, inputItemImg2,
          inputItemImg3, inputItemImg4, inputItemImg5, inputItemImg6, inputItemName, inputTitle,
          linearimage, linearimage1, toolbar, writeText);
    }

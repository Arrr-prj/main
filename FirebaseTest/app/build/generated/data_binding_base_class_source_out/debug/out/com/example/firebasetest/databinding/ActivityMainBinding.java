...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText inputItemCategory;
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull Button btnItemList,
      @NonNull Button btnItemRegist, @NonNull EditText inputItemCategory,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      EditText inputItemCategory = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainBinding((LinearLayout) rootView, btnItemList, btnItemRegist,
          inputItemCategory, inputItemExplain, inputItemImg, inputItemName, inputItemPrice,
          writeText);
    }

...
public class MyConfirmItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_confirm);
                ...
                .addOnCompleteListener(task -> {
                    if(task.isSuccessful()){
                        for (QueryDocumentSnapshot document : (task.getResult())){
                            Log.d(TAG, "구매해야하는 open 아이템 id : "+String.valueOf(document.getData().get("id")));
    ...
    public void InitializeBiddingItem(){
        ...
        db.collection("BiddingItem").whereEqualTo("buyer", uid)
                ...
                .addOnCompleteListener(task -> {
                    if(task.isSuccessful()){
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            Log.d(TAG, "구매해야하는 bidding 아이템 id : "+String.valueOf(document.getData().get("id")));

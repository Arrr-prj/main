...
public class OpenDetailItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(OpenDetailItemActivity.this, id, Toast.LENGTH_SHORT).show();
        String title = intent.getStringExtra("title");
        String documentId = title + id;
        Toast.makeText(OpenDetailItemActivity.this, documentId, Toast.LENGTH_SHORT).show();
        ...
        mBtnBidButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!mBtnBidButton.isEnabled()) {
                    Toast.makeText(OpenDetailItemActivity.this, "경매가 이미 종료되었습니다.", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void setoValues(Item selectedItem) {
        database.collection("OpenAuctionInProgress")
                .addSnapshotListener((value, error) -> {
                    ...
                    String aa = selectedItem.getfutureDate();
                    Long futureMillisValue = Long.valueOf(aa); // 형변환
                    long remainingTimeMillis = futureMillisValue - currentTimeMillis;
    ...
    private void getSelectoItem() {
        ...
        if (selectedItem != null) {
            ...
            // 경매 종료 여부를 확인하고 버튼을 비활성화
            long currentTimeMillis = System.currentTimeMillis();
            String aa = selectedItem.getfutureDate();
            Long futureMillisValue = Long.valueOf(aa); // 형변환
            if (currentTimeMillis >= futureMillisValue) {
